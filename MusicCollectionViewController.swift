...
class MusicCollectionViewController: UICollectionViewController {
    var MusicsubjectsArray = ["Guitar","Piano","Drums","Violin","DJing","Painting"]
    var MusicsubImageArray = [UIImage(named: "Guitar"),UIImage(named: "Piano"),UIImage(named: "Drums"),UIImage(named: "Violin"),UIImage(named: "DJing"),UIImage(named: "Painting")]
    var attributes = [
    ...
    override func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return self.MusicsubjectsArray.count
    }
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        cell.backgroundImageView.image =  self.MusicsubImageArray[indexPath.row]
        cell.moodTitleLabel.text = self.MusicsubjectsArray[indexPath.row];
        
        return cell
    }
    override func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        let cs = self.MusicsubjectsArray[indexPath.row]
        subjectString = cs
